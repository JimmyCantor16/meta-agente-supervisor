...
const es = {
  ...
  curso: {
    ...
    tocaCodigo: "Esta clase se hace tocando código",
    deberiasVer: "Deberías ver",
    irAlAula: "Ir al aula en vivo",
    ...
    retoParaTi: "Reto para ti",
    nivelVigente: (nivel: string) => `El profesor ya te conoce: nivel ${nivel}.`,
    volverAMedirme: "Volver a medirme",
    nivelBajo: "principiante",
    nivelMedio: "intermedio",
    nivelAlto: "avanzado",
  },
  camino: {
    titulo: "Mi camino",
    subtitulo:
      "Tu racha, tus cursos y tus certificados, en un solo lugar. La racha crece cada día que vuelves.",
    cargando: "Cargando tu camino…",
    reintentar: "Reintentar",
    rachaTitulo: "Racha",
    rachaDias: (n: number) => (n === 1 ? "1 día seguido" : `${n} días seguidos`),
    ultimos7: "Últimos 7 días",
    proximoPaso: "Tu próximo paso",
    continuar: "Continuar",
    cursosTitulo: "Tus cursos",
    clasesDe: (hechas: number, total: number) => `${hechas} de ${total} clases`,
    graduadoChip: "Graduado",
    certificadosTitulo: "Tus certificados",
    imprimir: "Imprimir",
    certificadoDe: "Certificado del curso",
    otorgadoEl: "Otorgado el",
    sinCertificados: "Termina un curso y tu primer certificado aparecerá aquí.",
    vacioTitulo: "Aún no has empezado ningún curso",
    vacioCuerpo:
      "Genera un proyecto con tu idea, o pide un tema en «Aprender», y el profesor abre tu primer curso. Tu racha empieza el día que empiezas tú.",
    vacioCta: "Empezar ahora",
  },
  metas: {
  ...
  despliegue: {
    titulo: "Publicar en internet",
    intro:
      "El agente sube tu proyecto a un repositorio y lo publica en Render por ti. En unos minutos tendrás una URL pública para compartir.",
    boton: "Publicar en internet",
    republicar: "Publicar de nuevo",
    reintentar: "Reintentar",
    publicandoHint:
      "Esto tarda unos minutos. Puedes seguir usando la app: el resultado aparece aquí.",
    chipEnCurso: "Publicando…",
    chipVivo: "Vivo",
    chipFallido: "Falló",
    chipCaido: "Caído",
    vivoTitulo: "Tu sistema está publicado en:",
    copiar: "Copiar URL",
    copiado: "Copiada",
    repo: "Ver el código",
    falloTitulo: "La publicación falló",
    caidoTitulo: "La URL publicada no responde ahora mismo",
    ultimoChequeo: "Último chequeo",
    viaAutomatica: "Vía rápida: el agente lo publica por ti",
    viaManual: "¿Prefieres aprender a hacerlo tú? Sigue las tres clases de abajo.",
  },
  secretos: {
  ...
  aula: {
    ...
    claseNumero: "Clase",
    deberiasVer: "Deberías ver",
    guardadoComo: "guardado como",
    deshacer: "Deshacer",
    deshaciendo: "Deshaciendo…",
    deshacerAyuda: "Vuelve al último punto que funcionaba. Solo deshace tus cambios.",
    deshecho: "Deshecho",
    errorDeshacer: "No pude deshacer el cambio.",
    misionAqui: "La misión de la clase se hace en este archivo",
  },
  usage: {
  ...
  notif: {
    ...
    enable: "Activar avisos del sistema",
    enabled: "Avisos del sistema activados",
    generatedTitle: "¡Tu sistema está listo! 🎉",
    generatedBody: (name: string) => `«${name}» terminó de generarse.`,
    generatedReady: "Ya puedes abrirlo.",
  ...
  monitor: {
    ...
    switches: "Saltos de IA",
    time: "Tiempo",
    brain: "Cerebro IA (proveedores)",
    hit: "acierto",
    current: "Respondiendo",
    noBrain: "Aún ninguna IA ha respondido.",
    log: "Registro en vivo",
    waiting: "Esperando actividad… genera un proyecto y verás cada paso aquí.",
    openUrl: "Abrir el sistema generado",
  },
  multimedia: {
    title: "Multimedia",
    close: "Cerrar",
    ...
    radioTab: "📻 Radio",
    ytTab: "▶ YouTube",
    ytAddLabel: "Pega un enlace de YouTube",
    ytAdd: "Añadir",
    ytHint:
      "Vale un vídeo o una lista. Al pegarlo se busca su título real. Todo queda guardado solo en tu navegador.",
    ytEmptyPlayer: "Elige algo de la lista y suena aquí, sin salir de la plataforma.",
    ytEmptyList: "Tu lista está vacía. Pega arriba el enlace de lo que quieras oír mientras estudias.",
    ytPlaylist: "Lista de reproducción",
    ytOpenExternal: "Abrir en YouTube (para dar like, comentar o suscribirte)",
    ytBadLink: "Ese enlace no parece de YouTube. Copia el que te da el botón «Compartir».",
    ytDuplicate: "Eso ya está en tu lista.",
    ytUntitled: "Vídeo de YouTube",
    ytApiError: "No pude cargar el reproductor de YouTube. Revisa tu conexión.",
    ytPlayError: "Ese vídeo no se puede reproducir aquí (puede ser privado o no permitir incrustarse).",
    live: "En vivo",
    play: "Reproducir",
    pause: "Pausar",
    stopTitle: "Detener",
    ...
    mini: "Mini",
    dock: "Acoplar",
    dockBack: "↩ Acoplar el vídeo en el panel",
    pip: "Picture-in-Picture",
    popOut: "Fuera",
    popOutTitle: "Sacar del navegador: flota sobre otros programas y puedes minimizar Chrome",
    ...
    remove: "Eliminar",
    search: "Buscar",
    iptvTitle: "Canales de Colombia (IPTV)",
    iptvLoad: "⬇ Cargar canales de Colombia",
    iptvReload: "↻ Recargar lista",
    iptvLoading: "Cargando canales…",
    iptvError: "No se pudo cargar la lista IPTV. Reintenta.",
    iptvHint:
      "Lista pública y en vivo de iptv-org. Algunos canales pueden estar caídos o con restricción de región.",
    // TV
    tvEmpty: "Elige o agrega un canal para verlo aquí",
    tvAddTitle: "Agregar canal (URL .m3u8)",
    tvNamePh: "Nombre del canal",
    tvUrlPh: "https://…/stream.m3u8",
    tvAdd: "＋ Agregar canal",
    tvHint:
      "La app no trae canales: pega la URL .m3u8 de un canal legal/gratuito. Se guarda solo en tu navegador.",
    tvNoChannels: "Aún no has agregado canales.",
    tvError: "No se pudo reproducir el canal (URL o formato no válido).",
    // Radio
    radioSearchPh: "Buscar emisora…",
    radioEmpty: "Sin emisoras. Prueba otra búsqueda o país.",
    radioError: "No se pudo reproducir la emisora.",
    radioLoadError: "No se pudo conectar con la radio. Revisa tu conexión.",
    radioFallback: "Buscador global no disponible ahora — mostrando emisoras destacadas (suenan igual).",
  },
...
const en: Translation = {
  ...
  curso: {
    ...
    tocaCodigo: "This class is done by touching code",
    deberiasVer: "You should see",
    irAlAula: "Go to the live classroom",
    ...
    retoParaTi: "A challenge for you",
    nivelVigente: (nivel: string) => `The teacher already knows you: ${nivel} level.`,
    volverAMedirme: "Measure me again",
    nivelBajo: "beginner",
  ...
  camino: {
    titulo: "My path",
    subtitulo:
      "Your streak, your courses and your certificates, in one place. The streak grows every day you come back.",
    cargando: "Loading your path…",
    reintentar: "Retry",
    rachaTitulo: "Streak",
    rachaDias: (n: number) => (n === 1 ? "1 day in a row" : `${n} days in a row`),
    ultimos7: "Last 7 days",
    proximoPaso: "Your next step",
    continuar: "Continue",
    cursosTitulo: "Your courses",
    clasesDe: (hechas: number, total: number) => `${hechas} of ${total} classes`,
    graduadoChip: "Graduated",
    certificadosTitulo: "Your certificates",
    imprimir: "Print",
    certificadoDe: "Course certificate",
    otorgadoEl: "Awarded on",
    sinCertificados: "Finish a course and your first certificate will show up here.",
    vacioTitulo: "You haven't started any course yet",
    vacioCuerpo:
      "Generate a project from your idea, or ask for a topic in “Learn”, and the teacher opens your first course. Your streak starts the day you do.",
    vacioCta: "Start now",
  },
  metas: {
  ...
  despliegue: {
    titulo: "Publish to the internet",
    intro:
      "The agent pushes your project to a repository and publishes it on Render for you. In a few minutes you'll have a public URL to share.",
    boton: "Publish to the internet",
    republicar: "Publish again",
    reintentar: "Retry",
    publicandoHint: "This takes a few minutes. You can keep using the app: the result shows up here.",
    chipEnCurso: "Publishing…",
    chipVivo: "Live",
    chipFallido: "Failed",
    chipCaido: "Down",
    vivoTitulo: "Your system is published at:",
    copiar: "Copy URL",
    copiado: "Copied",
    repo: "View the code",
    falloTitulo: "The publish failed",
    caidoTitulo: "The published URL is not responding right now",
    ultimoChequeo: "Last check",
    viaAutomatica: "Fast lane: the agent publishes it for you",
    viaManual: "Prefer to learn to do it yourself? Follow the three classes below.",
  },
  secretos: {
  ...
  aula: {
    ...
    claseNumero: "Class",
    deberiasVer: "You should see",
    guardadoComo: "saved as",
    deshacer: "Undo",
    deshaciendo: "Undoing…",
    deshacerAyuda: "Goes back to the last point that worked. Only undoes your changes.",
    deshecho: "Undone",
    errorDeshacer: "I couldn't undo the change.",
    misionAqui: "This class's mission happens in this file",
  },
  usage: {
  ...
  notif: {
    ...
    enable: "Enable system alerts",
    enabled: "System alerts enabled",
    generatedTitle: "Your system is ready! 🎉",
    generatedBody: (name: string) => `"${name}" finished generating.`,
    generatedReady: "You can open it now.",
  ...
  monitor: {
    title: "Live monitor",
    subtitle: "Every phase, every AI and every hit/miss of the pipeline, in real time.",
    live: "Live",
    offline: "Offline",
    ...
    time: "Time",
    brain: "AI Brain (providers)",
    hit: "hit rate",
    current: "Answering",
    noBrain: "No AI has answered yet.",
    log: "Live log",
    waiting: "Waiting for activity… generate a project and you'll see every step here.",
    openUrl: "Open the generated system",
  },
  multimedia: {
    title: "Media",
    close: "Close",
    ...
    radioTab: "📻 Radio",
    ytTab: "▶ YouTube",
    ytAddLabel: "Paste a YouTube link",
    ytAdd: "Add",
    ytHint:
      "A video or a playlist works. Pasting it looks up the real title. Everything stays in your browser only.",
    ytEmptyPlayer: "Pick something from the list and it plays right here, without leaving the platform.",
    ytEmptyList: "Your list is empty. Paste above whatever you want playing while you study.",
    ytPlaylist: "Playlist",
    ytOpenExternal: "Open on YouTube (to like, comment or subscribe)",
    ytBadLink: "That doesn't look like a YouTube link. Copy the one from the Share button.",
    ytDuplicate: "That's already in your list.",
    ytUntitled: "YouTube video",
    ytApiError: "Couldn't load the YouTube player. Check your connection.",
    ytPlayError: "That video can't play here (it may be private or not allow embedding).",
    live: "Live",
    play: "Play",
    pause: "Pause",
    stopTitle: "Stop",
    ...
    mini: "Mini",
    dock: "Dock",
    dockBack: "↩ Dock the video back into the panel",
    pip: "Picture-in-Picture",
    popOut: "Pop out",
    popOutTitle: "Pop out of the browser: floats over other apps and you can minimize Chrome",
    ...
    remove: "Remove",
    search: "Search",
    iptvTitle: "Colombia channels (IPTV)",
    iptvLoad: "⬇ Load Colombia channels",
    iptvReload: "↻ Reload list",
    iptvLoading: "Loading channels…",
    iptvError: "Couldn't load the IPTV list. Try again.",
    iptvHint:
      "Public, live list from iptv-org. Some channels may be down or region-locked.",
    // TV
    tvEmpty: "Pick or add a channel to watch it here",
    tvAddTitle: "Add channel (.m3u8 URL)",
    tvNamePh: "Channel name",
    tvUrlPh: "https://…/stream.m3u8",
    tvAdd: "＋ Add channel",
    tvHint:
      "The app ships no channels: paste a legal/free channel's .m3u8 URL. It is stored only in your browser.",
    tvNoChannels: "You haven't added any channels yet.",
    tvError: "Couldn't play the channel (invalid URL or format).",
    // Radio
    radioSearchPh: "Search station…",
    radioEmpty: "No stations. Try another search or country.",
    radioError: "Couldn't play the station.",
    radioLoadError: "Couldn't reach the radio service. Check your connection.",
    radioFallback: "Global search unavailable right now — showing featured stations (they still play).",
  },
