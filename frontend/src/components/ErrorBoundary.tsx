    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-surface-muted p-6">
        <div className="w-full max-w-md rounded-2xl border border-black/10 bg-white p-6 shadow-lg">
          <h1 className="text-lg font-bold text-ink">Algo se rompió en la pantalla</h1>
          ...
          <pre className="mt-3 max-h-32 overflow-auto rounded-lg bg-slate-900 p-3 text-xs text-ink-faint">
            {error.message}
          </pre>
          <button
            type="button"
